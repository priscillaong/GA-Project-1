...
This project only studied how total SAT score is affected based on the participating rates in different States. Other factors such as wealth, race, quality of education, gender, SAT fee waiver should be studied upon to correctly identify how to increase  increase the participation rates for SAT across the US.
